...
if (answer1.Q1 === "B => abc.ts") {
    console.log(chalk.yellow("\n\t***** You are right answer: your mark is :", chalk.red((totalObtmark += oneQsMark))));
    console.log("=======================================================================================");
}
else {
...
let answer2 = await inquirer.prompt([
    {
        name: "Q2",
        type: "list",
        message: chalk.green("QS:2 = Which of the following is NOT a valid TypeScript data type?"),
...
let answer3 = await inquirer.prompt([
    {
        name: "Q3",
        type: "list",
        message: chalk.green("QS:3 = How do you denote a variable as readonly in TypeScript?"),
...
let answer4 = await inquirer.prompt([
    {
        name: "Q4",
        type: "list",
        message: chalk.green("QS:4 = Which command would you use to install TypeScript globally using npm ?"),
        choices: [
...
let answer5 = await inquirer.prompt([
    {
        name: "Q5",
        type: "list",
        message: chalk.green("QS:5 = Which of the following TypeScript types can the unknown type be assigned to without type assertion ?"),
        choices: ["A => string", "B => number", "C => any", "D => void"],
    },
]);
if (answer5.Q5 === "C => any") {
    console.log(chalk.yellow("\n\t***** You are right answer: your mark is :", chalk.redBright((totalObtmark += oneQsMark))));
    console.log("========================================================================================");
}
else {
    console.log(chalk.red("\n\t======> You are wrong answer <======"));
...
console.log(chalk.black.bgBlue("\n\t==> Your Final Score is ====> "), chalk.black.bgRed(totalObtmark), chalk.black.bgWhite(" OUT OF "), chalk.black.bgRed(totalMarks));
console.log(chalk.black.bgGreen("\n\t==> Thank You for Attempting the Quiz "));
console.log(chalk.black.bgBlue("\n\t==> This Quiz made by ==>"), chalk.black.bgRed("'SANA FAISAL'"));
console.log(chalk.magenta("\n\t===========>**********************<==========="));
// THE END :
